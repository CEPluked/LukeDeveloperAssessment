...
setwd("C:/Users/luked/Desktop/cep-developer-assessment-master/exercise1/input")
library(plyr)
...
#output the means
out.path <- "C:/Users/luked/Desktop/cep-developer-assessment-master/exercise1/submissions"
write.csv(fdn.mean, paste(out.path, "mean.csv", sep = "/"), row.names = F)
...
write.csv(fdn.stats, paste(out.path, "stats.csv", sep="/"), row.names = F)